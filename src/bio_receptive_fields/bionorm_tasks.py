...
from adversarialML.biologically_inspired_models.src.biological_normalization.bionorm import BioNormWrapper
...
class Ecoset10CyclicLRRandAugmentBioNormXResNet2x18(AbstractTask):
    ...
    def get_model_params(self):
        ...
        p = BioNormWrapper.ModelParams(BioNormWrapper, resnet_p, 7)
        return p
